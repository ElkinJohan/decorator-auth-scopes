...
class HeaderValidatorInterceptorTest {
    ...
    void testPreHandle_ClassLevelAuth_ReturnsTrue() throws NoSuchMethodException {
        ...
        HandlerMethod handlerMethodClass = new HandlerMethod(testInstance, HeaderValidatorInterceptorTest.TestClass.class.getMethod("toString")); // Usar cualquier método
